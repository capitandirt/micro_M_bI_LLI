...
#define ANGLE_REG_EXPLORER_KP 6
/*==SEARCH CONSTS END==*/
...
#define ANGLE_SPEED_OPTOCOUPLER_ONESEN_REG_K (0.005 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]
#define ANGLE_SPEED_OPTOCOUPLER_TWOSEN_REG_K (0.01 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]  
