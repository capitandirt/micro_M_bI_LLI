...
#define ANGLLE_SPEED_OPTOCOUPLER_ONESEN_REG_K (0.005 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]
...
#define BACK_ALIGNMENT_TIME (HALF(CELL_SIZE)/FORWARD_SPEED * 1000 + 300) // ms
