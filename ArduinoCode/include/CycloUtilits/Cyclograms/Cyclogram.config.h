...
#define ANGLE_SPEED_OPTOCOUPLER_ONESEN_REG_K (0.007 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]
#define ANGLE_SPEED_OPTOCOUPLER_TWOSEN_REG_K (0.007 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]  
