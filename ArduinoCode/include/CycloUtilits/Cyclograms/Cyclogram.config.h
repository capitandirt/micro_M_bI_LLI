...
#define ANGLE_REG_EXPLORER_KP 8
/*==SEARCH CONSTS END==*/
...
#define ANGLE_SPEED_OPTOCOUPLER_ONESEN_REG_K (0.001 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]
#define ANGLE_SPEED_OPTOCOUPLER_TWOSEN_REG_K (0.001 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]  
...
#define ANGLE_REG_KP 3
#define ANGLE_REG_THRESHOLD 45
/*==ANGLE REGULATOR END==*/


/*==IN PLACE ANGLE REGULATOR BEGIN==*/
#define ANGLE_REG_IN_PLACE_KP 3.5
#define ANGLE_REG_IN_PLACE_KI (ANGLE_REG_IN_PLACE_KP / 7) 
#define IP_CALIB_TIME 0.1 // c
/*==IN PLACE ANGLE REGULATOR END==*/

/*==ALIGNMENT BEGIN==*/
#define MAX_NO_ALIGN_COUNTER_DEFINE 6
/*==ALIGNMENT END==*/
