...
#define FWD_SPEED_MULTIPLIER 1.4
#define FWDE_SPEED_MULTIPLIER 1

#define NEED_FWD_ACC 1
#if NEED_FWD_ACC
    #define FWD_ACCELERATION 0.25
#endif
...
#define ROBOT_HEIGHT 0.13
#define FROM_WHEEL_TO_SIDE 0.05
...
#define BACK_ALIGNMENT_TIME (HALF(CELL_SIZE)/FORWARD_SPEED * 1000 + 200) // ms
#define FORWARD_ALIGNMENT_TIME (HALF(CELL_SIZE)/FORWARD_SPEED * 1000 + 200) // ms
...
/*==ALIGNMENT BEGIN==*/
#define MAX_NO_ALIGN_COUNTER_DEFINE 3
/*==ALIGNMENT END==*/
