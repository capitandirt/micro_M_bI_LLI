...
#define ANGLLE_SPEED_OPTOCOUPLER_ONESEN_REG_K (0.03 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]
#define ANGLLE_SPEED_OPTOCOUPLER_TWOSEN_REG_K (0.03 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]  
