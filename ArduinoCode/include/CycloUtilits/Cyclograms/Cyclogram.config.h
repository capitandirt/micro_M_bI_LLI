...
#define SMART_FORWARD_SPEED 0.22

#define FWD_SPEED_MULTIPLIER 1.2
#define FWDE_SPEED_MULTIPLIER 1.32
...
#define ANGLE_SPEED_OPTOCOUPLER_ONESEN_REG_K (0.03 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]
#define ANGLE_SPEED_OPTOCOUPLER_TWOSEN_REG_K (0.03 + (FORWARD_SPEED * 0.00125)) // [analogValue -> рад/с]  
