...
---[ IN TEST CONVERT_PATH_TO_CYCLOGRAM:
    \--|
    IP180 FWD_HALF SS90EL SS90EL SS90ER FWD FWD FWD SS90ER FWD SS90ER FWD SS90EL SS90EL SS90ER SS90EL SS90ER FWD_HALF STOP
    ]
*/
...
#define OPTOCOUPLER_SENSE_THRESHOLD_LEFT (5)
#define OPTOCOUPLER_SENSE_THRESHOLD_FWD_L (5)
#define OPTOCOUPLER_SENSE_THRESHOLD_FWD_R (5)
#define OPTOCOUPLER_SENSE_THRESHOLD_RIGHT (7)
/*==OPTOCOUPLER END==*/


//*==ANGLE SPEED REGULATOR BEGIN==*/
#define ANGLLE_SPEED_OPTOCOUPLER_ONESEN_REG_K 10.0 // [analogValue -> рад/с]
#define ANGLLE_SPEED_OPTOCOUPLER_TWOSEN_REG_K 10.0 // [analogValue -> рад/с]
