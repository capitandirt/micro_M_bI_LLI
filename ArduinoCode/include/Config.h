...
#define OPTOCOUPLER_SENSE_ERROR (2)
#define OPTOCOUPLER_SENSE_THRESHOLD_LEFT (104)
#define OPTOCOUPLER_SENSE_THRESHOLD_FWD_L (75)
#define OPTOCOUPLER_SENSE_THRESHOLD_FWD_R (75)
#define OPTOCOUPLER_SENSE_THRESHOLD_RIGHT (104)
/*==OPTOCOUPLER END==*/
