...
void CycloWorker::load_Actions_funcs(){
    ...
    _Actions_funcs[static_cast<uint8_t>(SmartCycloAction_t::SS180L  )] = SS180L  ;
    _Actions_funcs[static_cast<uint8_t>(SmartCycloAction_t::SS180R  )] = SS180R  ;
    _Actions_funcs[static_cast<uint8_t>(SmartCycloAction_t::IP180   )] = IP180   ;
