...
void Robot::stateMachine(){
    ...
    case ProgramStatus::ESTIMATE_IS_90E:
        _is_90e = _functionalSelector->isLever(2);
    ...
    PRINT("status: ");
    PRINTLN((int)_programStatusSelector->getStatus());
}
...
void Robot::step_flood_fill(const Vec2 end_vec)
{
    ...
    _actionsHandler->loadExplorer(cur_dir, _is_90e);
